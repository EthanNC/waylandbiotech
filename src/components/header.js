  ...
  return (
    <nav class="flex items-center justify-between flex-wrap bg-black p-6">
      <div class="flex items-center text-white mr-6 ">
        ...
        <span class="font-semibold text-xl tracking-tight">Wayland BioTech</span>
      </div>
      ...
      <ul class="hidden sm:flex overflow-x-hidden mr-10 font-semibold ">
        <li class="mr-6 p-1">
          <a class="text-red-500 cursor-default" href="#">Home</a>
        </li>
        <li class="mr-6 p-1">
          <a class="text-white hover:text-red-500" href="#">About</a>
        </li>
        <li class="mr-6 p-1">
          <a class="text-white hover:text-red-500" href="#">Contact</a>
        </li>
      </ul>

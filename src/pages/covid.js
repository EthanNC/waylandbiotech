...
const Covid = () => (
    <Layout>
      ...
      <div class="bg-white">
            ...
            <img src={image} class=" "/>
            <h1 class="text-center text-2xl font-bold">Covid-19 Response</h1>
            ...
            <p class="mt-4">Wayland Biotherapeutics is creating decoy receptors containing LY6E with the goal of enhancing the LY6E restriction of SARS-CoV-2 and preventing viral entry into the cell.</p>

    ...
    <Layout>
      <SEO title="Platform" />
           <div class="bg-white">
            ...
            <p class="mt-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quidem laborum quas rem id architecto voluptatem at, est facere sed ab dolores! Quisquam repellat quam nesciunt nostrum asperiores temporibus soluta accusantium.</p>
            <div class="font-bold m-2">Focus on LY6E</div>
            <p class="mt-2">
            Lymphocyte antigen 6 complex, locus E (LY6E) is a glycosylphosphatidylinositol (GPI) -linked protein of a mere 133 amino acids in length. The GPI moiety It is also known as Thymic Shared Antigen-1 (TSA-1) or Stem Cell Antigen-2 (SCA-2). LY6E is member of the canonical lymphocyte antigen-6/urokinase-type plasminogen activator receptor (Ly6/uPAR) superfamily of proteins. 
            </p>
            <p class="mt-2">
